 ...
 * Jumbo tipografi sentral. Tanpa blob gradient, tanpa panel foto artifisial.
 */
export function Hero() {
  return (
    <section
      aria-label="Beranda"
      className="flex min-h-[calc(100vh-4rem)] items-center border-b border-charcoal-border/30 bg-charcoal py-16 md:py-20"
    >
